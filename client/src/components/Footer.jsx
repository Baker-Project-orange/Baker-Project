...
function Footer() {
  return (
    <footer className="text-center my-32 mx-auto  max-w-3xl">
            ...
            <ul className="space-y-2 text-center md:text-left">
              {[
                ...
                <li key={index}>
                  <a
                    href="#"
                    className="flex items-center justify-center md:justify-start space-x-2 text-amber-800 hover:text-amber-600 transition-colors duration-300"
                  >
