    ...
    <div className="bg-gradient-to-b from-white to-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-700 mb-6 text-lg">
              ...
              bringing the joy of baking to homes around the world. Our platform
              offers a curated collection of free recipes and exclusive premium
      ...
      <section className="bg-[#c98d83] py-24 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h2 className="text-4xl font-bold mb-12">What Our Community Says</h2>
          <blockquote className="text-2xl italic mb-8">
            "This platform has revolutionized my baking. The recipes are easy to
            follow, and the results are consistently amazing!"
          </blockquote>
